...
class PostgresClient:
    ...
    def load_data(self, schema: str, table: str, df: pd.DataFrame, columns: Optional[List[str]] = None):
    ...
    def get_new_ids_by_temp_table(self, warehouse_schema: str, table: str, 
                                  id_col: str, id_list: List[str]) -> List[str]:
        if not id_list:
            return []
    ...
    def read_table(self, schema: str, table: str, limit: Optional[int] = None) -> pd.DataFrame:
